        ...
        <div className="max-w-4xl mx-auto">
          <Card className="p-8 md:p-12 bg-gradient-to-br from-card to-secondary/30 border-border text-center">
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
              Explore o mapa interativo e veja territorios conquistados na sua cidade.
              Desenhe seu primeiro territorio agora.
            </p>
            <Link href="/mapa">
              <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 text-lg px-10 h-14">
